# house-swap
This contract manages a house-swap process between two users. It's developed on Solidity and hardhat.
You can read the first tutorial which show how the contract works here: 
